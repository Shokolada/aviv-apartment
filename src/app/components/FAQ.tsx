...
const faqs = [
  ...
  },
  {
    ...
    a: "התשלום מתבצע אחת לחודש בצ'ק או בהעברה בנקאית. שכר הדירה אינו כולל חשמל – קיים מונה נפרד, על פי צריכה (ממוצע שימוש ליחיד בין 70 – 100 ש\"ח לחודש). מס שמירה יישובי – 140 ש\"ח.",
  },
  {
  ...
  {
    q: "האם הדירה מרוהטת?",
    a: "הדירה מרוהטת קומפלט: בר עץ מלא + 2 כסאות בר, ספה, ארון מרווח, מקרר, מכונת כביסה, תנור אפייה בילד אין, מזגן.",
  },
];
