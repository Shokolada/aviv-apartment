...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 left-6 z-40 bg-[#25D366] hover:bg-[#1EBE5A] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg pulse-green transition-all duration-300 ${
